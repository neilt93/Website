...
This is a write-up of a research project I've been working on at Penn State's Vision-Language Lab. The goal was straightforward: build a lightweight scorer that can tell when a robot policy is about to do something wrong, and use it to pick better actions. The reality turned out to be more interesting than the plan.
...
| Fraction with improvement > 0.01 | 11% | 59% |
| Fraction with improvement > 0.1 | ~1% | ~35% |
